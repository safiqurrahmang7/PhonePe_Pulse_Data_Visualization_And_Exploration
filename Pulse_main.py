...
conn = pymysql.connect(host='localhost', user='root', password='root123', db='phonepe_pulse')
cursor = conn.cursor()
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("D:/phonepepulse/PhonePe_Pulse/Attachments/download.jpeg"), width=500)
        st.video("D:\phonepepulse\PhonePe_Pulse\Attachments\Introducing PhonePe Pulse.mp4")
    with col2:
        ...
        st.markdown("## :violet[By] : Safiqur Rahman")
        st.markdown("### [🔗 Inspired from PhonePe Pulse](https://www.phonepe.com/pulse/)")
        st.markdown("### [🐱 GitHub](https://github.com/safiqurrahmang7)")
        st.markdown("### [🔗 LinkedIn](https://www.linkedin.com/in/safiqurrahman)")
    st.write("---")
...
if selected == "Insights":
    ...
    with open("D:/phonepepulse/PhonePe_Pulse/Attachments/PhonePe_Pulse_BCG_report.pdf", "rb") as f:
        data = f.read()
...
if selected == "About":
    ...
    <div style="text-align: center;">
        <a href="https://www.phonepe.com/app-download/" style="display: inline-block; padding: 10px 20px; font-size: 20px; color: white; background-color: #6a0dad; border: none; border-radius: 5px; text-decoration: none; transition: background-color 0.3s ease;">
            DOWNLOAD APP
        </a>
    </div>
    """, unsafe_allow_html=True)